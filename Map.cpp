...
Location* GameNamespace::Map::addLocation(const std::string& name, const std::string& description) {
    Location* newLocation = new Location(name, description);
    locations.push_back(newLocation);
    return newLocation;
}

Location* GameNamespace::Map::findLocation(const std::string& name) {
...
void GameNamespace::Map::displayMap() const {
...
void GameNamespace::Map::displayConnections(Location* location) const {
    if (location) {
...
bool GameNamespace::Map::movePlayer(Player& player, Location* newLocation) {
